...
```
cd existing_repo
git remote add origin https://gitlab.datafari.com/sandboxespublic/llm-search-quality-evaluation.git
git branch -M main
...
* [Set up project integrations](https://gitlab.datafari.com/sandboxespublic/llm-search-quality-evaluation/-/settings/integrations)
...
### [Dataset Generator](src/llm_search_quality_evaluation/dataset_generator/README.md) 
...
#### [Embedding Model Evaluator](src/llm_search_quality_evaluation/vector_search_doctor/embedding_model_evaluator/README.md)
...
[Config](examples/configs/vector_search_doctor/embedding_model_evaluator/embedding_model_evaluator_config.yaml)) you can look at the 
[README](src/llm_search_quality_evaluation/vector_search_doctor/embedding_model_evaluator/README.md).
...
For a detailed description to fill in configuration file (e.g., 
[Config](examples/configs/vector_search_doctor/approximate_search_evaluator/approximate_search_evaluator_config.yaml)) you can look at the 
[README](src/llm_search_quality_evaluation/vector_search_doctor/approximate_search_evaluator/README.md).
